...
const BannerSlider = ({ data }: bannerProps) => {
  return (
    <header className="relative h-[480px] md:h-[450px] lg:h-[500px] xl:h-[600px] overflow-hidden">
      <Swiper
        ...
        {data?.map((item, idx) => {
          ...
          return (
            <SwiperSlide key={item?.id}>
              <div className="relative h-[450px] lg:h-[500px] xl:h-[600px]">
                {/* Background image */}
                <Image
                ...
                <Container>
                  <div
                    className={`flex items-center w-full h-[450px] lg:h-[500px] xl:h-[600px] ${
                      idx % 2 === 0 ? "justify-start" : "justify-end"
                    }`}
                  >
                    <div className="w-[480px] lg:w-[560px] bg-[rgba(246,245,240,0.90)] rounded-2xl px-6 lg:px-8 py-7 lg:py-12 shadow-[0_3px_8px_0_rgba(0,0,0,0.09),_0_3px_12px_0_rgba(0,0,0,0.10)]">
