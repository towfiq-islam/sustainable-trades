...
if (requiresShipping && (!user?.shop_info?.shipping_setting || (user?.shop_info?.shipping_setting === "shippo" && !user?.shop_info?.shippo_connected))) {
  toast(
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8 mt-4 md:mt-5">
          {/* ── LEFT ── */}
