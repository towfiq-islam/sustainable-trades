...
const MemberSpotlight = ({ data, has_community }: CommunityProps) => {
  const { user } = useAuth();
    ...
    <section className="rounded-xl">
      <Container>
        <div className="flex flex-col md:flex-row w-full">
          {/* Left */}
          <div className="flex-1 max-w-full md:max-w-[500px] h-[500px] xl:h-[549px] shrink-0 rounded-tl-lg rounded-bl-lg overflow-hidden relative">
            <Image
