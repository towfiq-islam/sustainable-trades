...
const CounterBottom = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row justify-between gap-10 border-b border-border-gray md:pb-8 ">
      <div className="w-full lg:w-1/2 border border-border-gray  rounded-lg shadow-sm flex flex-col bg-white mt-10">
        {/* Header */}
