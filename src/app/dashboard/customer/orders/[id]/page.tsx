      ...
      <div className="border border-[#BFBEBE] rounded-[8px] my-5 md:my-10">
        ...
        <div className="px-3 md:px-6 py-4">
          <ul className="flex flex-col md:flex-row justify-between">
            <div className="">
              <li className="text-black font-sans font-bold text-[16px]">
                Shipping Address
              </li>
              <ul className="flex flex-col gap-2">
                <li className="text-black font-sans font-normal text-[16px] flex gap-1 items-center">
                  <span>
                ...
                <li className="text-black font-sans font-normal text-[16px]">
            ...
            <div className="">
              ...
              <ul className="flex flex-col gap-2">
                <li className="text-black font-sans capitalize">
                  {getSingleOrder?.data?.payment_status}
                </li>
              </ul>
            </div>
            <div className="">
              <li className="text-black font-sans font-bold text-[16px] text-start">
                Order Summary
              </li>
              <ul className="flex flex-col gap-2 w-full">
                <li className="text-black font-sans font-normal text-[16px] flex justify-between gap-10">
                  Items Subtotal:
                ...
                <li className="text-black font-sans font-bold text-[16px] text-start flex justify-between gap-10">
                  Grand Total
      ...
      <div className="pt-2 px-4 pb-6 border border-[#BFBEBE] rounded-[8px]">
        <div className="flex flex-col gap-3.5 md:flex-row md:justify-between md:items-center">
          <div>
            ...
            <p className="font-sans font-normal text-black text-[16px] pt-2 pb-3">
          ...
          <div className="flex flex-col gap-4">
            <button
              onClick={() => isOpen(true)}
              className="p-2 rounded-[8px] border border-[#BFBEBE] text-[14px] md:text-[16px]  font-normal text-black cursor-pointer w-full md:w-[250px] hover:scale-105 duration-500 ease-in-out"
            >
              Track Package
            </button>
