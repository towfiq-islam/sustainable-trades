    ...
    <section className="h-screen max-h-screen flex flex-col lg:flex-row">
      ...
      <div className="flex-1 grid place-items-center side-scrollbar w-[90%] mx-auto -mt-40 lg:mt-0 z-50 bg-white lg:bg-transparent rounded-[8px] lg:rounded-0 ">
        <div className=" p-3.5 md:p-5 lg:p-10">
          ...
          <p className="text-lg 2xl:text-xl font-semibold text-primary-green mb-4 2xl:mb-7">
                ...
                <div className="space-y-4 2xl:space-y-5">
                  {item.feathers.map((list, idx) => (
                    <div key={idx} className="flex gap-2">
                      ...
                      {/* Right - description */}
                      <p className="text-secondary-black text-sm 2xl:text-base">
                        {list}
                      </p>
                    </div>
                  ))}
          ...
          >
            <button className="px-10 py-1.5 md:py-2 lg:py-3 3xl:py-4 border-2 border-primary-green rounded-lg bg-primary-green text-accent-white font-semibold cursor-pointer duration-500 transition-all hover:bg-transparent hover:text-primary-green md:text-base text-sm 2xl:text-lg w-full md:w-auto">
              Get Started!
            </button>
          </div>

          <div className="flex justify-center md:justify-end gap-1 items-center text-sm 2xl:text-lg text-secondary-black">
