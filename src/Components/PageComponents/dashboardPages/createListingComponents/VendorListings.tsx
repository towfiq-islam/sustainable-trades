...
import { FiEdit2, FiGrid, FiList, FiPackage } from "react-icons/fi";
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between mt-6">
        ...
        <Link
          href={`/dashboard/${variant === "pro" ? "pro" : "basic"}/create-listing`}
          className="h-[45px] lg:h-[48px] rounded-[8px] bg-accent-red text-[15px] font-semibold text-secondary-black cursor-pointer hover:bg-transparent duration-300 ease-in-out border border-accent-red w-full lg:w-fit px-5 flex gap-x-2 justify-center items-center shrink-0"
        >
          <FaPlus />
          Add New Listing
        </Link>
          ...
          {products.map(product => (
            ...
            >
              <div className="relative w-full h-[270px]">
                ...
                <Link
                  href={`/dashboard/${variant === "pro" ? "pro" : "basic"}/listing/${product.id}`}
                >
                  <button
                ...
                {products.map(p => (
                  ...
                  >
                    ...
                    <td className="relative">
                      <Link
                        href={`/dashboard/${variant === "pro" ? "pro" : "basic"}/listing/${p.id}`}
